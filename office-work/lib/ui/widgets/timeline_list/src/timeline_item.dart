...
import 'package:flutter_wanandroid/ui/widgets/timeline_list/src/timeline_painter.dart';
import 'package:flutter_wanandroid/ui/widgets/timeline_list/timeline.dart';
import 'package:flutter_wanandroid/ui/widgets/timeline_list/timeline_model.dart';
...
//                  const EdgeInsets.only(left: TimelineBoxDecoration.LINE_GAP),
              constraints: BoxConstraints(
                  minHeight: margin,
                  maxWidth: constraints.maxWidth - margin * 1.5
              ),
              child: model.child),
        ],
      );
