<template>
  <f7-page>
    <div  >
      ...
      <div>
        <div class="photo"  >
           <div v-for="(item,index) in imgList" :key="index" @click="uploadIDCards(0)"> 
            <img :src="item"  @click="imgs(index)"  width="210" height="145"  v-show="show"/>
           </div> 
           <div >        
      ...
      <div>   
        <div class="photo" v-if="imgList.length>0"   @click="uploadIDCardss(0)">
