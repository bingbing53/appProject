  ...
  <div class="app-container">
    <div class="table-layout">
      <el-row>
        ...
        <el-col :span="6" class="table-cell-title">使用门槛</el-col>
        <el-col :span="6" class="table-cell-title">面值</el-col>
        <el-col :span="6" class="table-cell-title">状态</el-col>
      </el-row>
      <el-row>
        <el-col :span="6" class="table-cell">{{coupon.name}}</el-col>
        ...
        <el-col :span="6" class="table-cell">满{{coupon.minPoint}}元可用</el-col>
        <el-col :span="6" class="table-cell">{{coupon.amount}}元</el-col>
        <el-col :span="6" class="table-cell">{{coupon.endTime | formatStatus}}</el-col>
      </el-row>
      <el-row>
        <el-col :span="6" class="table-cell-title">有效期</el-col>
        <el-col :span="6" class="table-cell-title">总发行量</el-col>
        <el-col :span="6" class="table-cell-title">已领取</el-col>
        <el-col :span="6" class="table-cell-title">待领取</el-col>
        <!-- <el-col :span="4" class="table-cell-title">已使用</el-col> -->
        <!-- <el-col :span="4" class="table-cell-title">未使用</el-col> -->
      </el-row>
      <el-row>
        <el-col :span="6" class="table-cell" style="font-size: 13px">
          {{coupon.startTime|formatDate}}至{{coupon.endTime|formatDate}}
        </el-col>
        <el-col :span="6" class="table-cell">{{coupon.publishCount}}</el-col>
        <el-col :span="6" class="table-cell">{{coupon.receiveCount}}</el-col>
        <el-col :span="6" class="table-cell">{{coupon.publishCount-coupon.receiveCount}}</el-col>
    ...
    <div class="table-container">
      <el-table ref="couponHistoryTable"
        ...
        <el-table-column label="领取用户" width="160" align="center">
        ...
        <el-table-column label="领取时间" width="200" align="center">
        ...
        <el-table-column label="使用时间" width="200" align="center">
