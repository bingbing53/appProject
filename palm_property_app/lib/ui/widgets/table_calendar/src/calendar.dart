    ...
    children.add(
      GestureDetector(
        ...
        child:Container(
          ...
          child: widget.calendarController.calendarFormat == CalendarFormat.week ? Icon(Icons.keyboard_arrow_down,color: Colors.grey,):Icon(Icons.keyboard_arrow_up,color: Colors.grey),
        ),
        onTap: (){
          widget.calendarController.toggleCalendarFormat();
        },
        ...
        return Center(
          child: Text(
            widget.daysOfWeekStyle.dowTextBuilder != null
                ? widget.daysOfWeekStyle.dowTextBuilder(date, widget.locale).replaceAll('周', '')
                : DateFormat.E(widget.locale).format(date).replaceAll('周', ''),
