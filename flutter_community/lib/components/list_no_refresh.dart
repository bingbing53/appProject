 ...
 * 不需要下拉刷新
 */
class ListNoRefresh extends StatefulWidget {
  final renderItem;
  final requestApi;
  final headerView;

  const ListNoRefresh([this.requestApi, this.renderItem, this.headerView]) : super();

  @override
  State<StatefulWidget> createState() => _ListNoRefreshState();
}

class _ListNoRefreshState extends State<ListNoRefresh> {
  ...
  * */
  Widget _buildLoadText() {
    return Container(
      ...
      child: Center(
        child: Text("- end -",style: AppText.Info_Size_Small_Gray,),
      ),
    ));
  }
