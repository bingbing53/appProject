  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrCateTable"
        ...
        <el-table-column label="种类名称" align="center">
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            <div v-show='scope.row.sysCompanyCode=="default"'>
              <p>系统内置</p>
            </div>
            <div v-show='scope.row.sysCompanyCode!="default"'>
              <el-button
  ...
  export default {
    ...
    methods: {
      ...
      getAttrList(index, row) {
        this.$router.push({path: '/pms/productAttrList',query:{cid:row.id,cname:row.name,sysCompanyCode:row.sysCompanyCode,type:0}})
      },
      getParamList(index, row) {
        this.$router.push({path: '/pms/productAttrList',query:{cid:row.id,cname:row.name,sysCompanyCode:row.sysCompanyCode,type:1}})
      },
