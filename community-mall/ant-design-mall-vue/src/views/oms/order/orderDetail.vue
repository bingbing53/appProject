  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        ...
        <span class="color-danger">当前订单状态：{{order | formatStatus}}</span>
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">用户</el-col>
          <el-col :span="4" class="table-cell-title">支付方式</el-col>
          <el-col :span="4" class="table-cell-title">订单来源</el-col>
          <el-col :span="4" class="table-cell-title">订单类型</el-col>
        </el-row>
        <el-row>
          <el-col :span="4" class="table-cell"><span style="font-size: 12px;">{{order.orderSn}}</span></el-col>
        ...
        <el-row>
          ...
          <el-col v-if="order.orderType === 1" :span="8" class="table-cell-title">预约时间</el-col>
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell"><span v-if="!!orderSetting.confirmOvertime">{{orderSetting.confirmOvertime}}</span>天</el-col>
          <el-col v-if="order.orderType === 1" :span="8" class="table-cell">{{order.appointTime}}</el-col>
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell" style="word-break:break-all;line-height: 18px;overflow: auto;">{{order | formatAddress}}</el-col>
        </el-row>
        <el-row>
          <el-col :span="6" class="table-cell-title">留言</el-col>
        </el-row>
        <el-row>
          <el-col :span="6" class="table-cell">{{order.buyerNote}}</el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="getPreviewUrl(scope.row.productPic)" style="height: 80px">
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    filters: {
      ...
      formatStatus(item) {
        let value = item.orderStatus || item.status
