...
class GZXSearchArticleResultListWidget extends StatelessWidget {
  final SearchArticleResultListModal list;
  final ValueChanged<String> onItemTap;
  final VoidCallback getNextPage;

  GZXSearchArticleResultListWidget(this.list, {this.onItemTap, this.getNextPage});
...
//            itemExtent: 127,
            itemBuilder: (BuildContext context, int i) {
              ...
              return ListArticleViewItem(item:list.data[i]);
