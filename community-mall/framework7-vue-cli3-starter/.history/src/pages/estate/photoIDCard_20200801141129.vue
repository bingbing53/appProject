<template>
  <f7-page>
    <div>
      ...
      <div>
        <div class="photo" @click="uploadIDCard(0)" id="upload_file" type="file"  name="file">
          <div v-for="(item,index) in detailData.rows.image" :key="index"> 
            <img :src="item" alt @click="imgs(index)" />
           </div>         
