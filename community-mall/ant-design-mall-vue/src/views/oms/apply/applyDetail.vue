  ...
  <div class="detail-container">
      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="160" align="center">
          <template slot-scope="scope">
            <img style="height:80px" :src="getPreviewUrl(scope.row.productPic)">
          </template>
        </el-table-column>
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">用户</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.userName}}</el-col>
        </el-row>
        <el-row>
