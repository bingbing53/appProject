...
class MallActivityPage extends StatefulWidget {
  final String url,type;

  MallActivityPage({this.url,this.type});

  @override
  MallActivityPageState createState() => new MallActivityPageState();
}

class MallActivityPageState extends State<MallActivityPage> with AutomaticKeepAliveClientMixin{
  ...
  Future<Map> getIndexListData([Map<String, dynamic> params]) async {
    ...
    final _param  = {'pageNo':pageIndex,'street':street,'departType':2};
