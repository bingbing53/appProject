    ...
    methods:{
      loadDepartList(){
        return new Promise(resolve => {
          let url = window._CONFIG['ssoPrefixUrl']+"/sys/user/getCurrentUserDeparts"
          this.currDepartName=''
      ...
      departOk(){
        ...
        putAction(window._CONFIG['ssoPrefixUrl']+"/sys/selectDepart",obj).then(res=>{
          if(res.success){
            ...
            this.$message.success('部门切换成功，请重新登录！');
            setTimeout(function(){
