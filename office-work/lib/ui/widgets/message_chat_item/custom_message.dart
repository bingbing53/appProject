          ...
          GestureDetector(
            ...
            onTap: (){
              ...
              if(ObjectUtil.isNotEmpty(message.prefix) && ObjectUtil.isNotEmpty(message.rid)){
                ...
                if (message.action == 'mission') {
                  MissionModel missionModel = MissionModel.fromJson(
                      {'id': message.rid});
                  ...
                  NavigatorUtil.pushPage(
                    ...
                    BlocProvider<MissionBloc>(
                      child: MissionDetailPage(
                          labelId: Ids.titleMission, mission: missionModel),
                  ...
                  NavigatorUtil.pushPage(
                    ...
                    BlocProvider<MissionBloc>(
                      child: MeetingDetailPage(
                        labelId: Ids.titleMeeting, meetingId: message.rid,),
                      bloc: new MissionBloc(),
                    ),
                    pageName: Ids.titleMeeting,
                  );
                } else if (message.action == 'blowill') {
                  NavigatorUtil.pushPage(
                    context,
                    BlocProvider<MissionBloc>(
                      child: BlowWillRecordPage(missionId: message.rid,),
                      bloc: new MissionBloc(),
                    ),
                    pageName: Ids.titleMission,
                  );
