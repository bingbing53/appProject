<template>
  <f7-page>
    ...
    <div>
      ...
      <div>
            <div  v-if="imageArr.length > 0" v-for="(item,index) in imageArr" :key="index">
            <div class="photo"  >
                <img class="camerabox" id="newImage1" src="index">
                <!-- <input class="fileInpBtn" id="fileInpBtn1" type="file" accept="image/*"> -->
                <div id="camera1">
                  <i class="aui-iconfont aui-icon-camera cameraPicture"  @click="uploadIDCard">+</i>
      ...
      <div>   
          <div  v-if="imageArr.length > 0" v-for="(item,index) in imageArr" :key="index"></div>
          <div class="photo"  >
            <img class="camerabox" id="newImage2" src="index">
