    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="所属楼宇">
          <a-input placeholder="请输入所属楼宇" v-decorator="['tBuildingId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="所属小区">
          <a-input placeholder="请输入所属小区" v-decorator="['tVillageId', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="楼宇名称">
          <a-input placeholder="请输入楼宇名称" v-decorator="['tBuildingName', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="单元号">
          <a-input placeholder="请输入单元号" v-decorator="['unitNo', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="单元名称">
          <a-input placeholder="请输入单元名称" v-decorator="['unitName', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'tBuildingId','tVillageId','tBuildingName','unitNo','unitName','createName','updateName','sysOrgCode','sysOrgName','sysCompanyCode','sysCompanyName','areaCode','areaName'))
		  //时间格式化
