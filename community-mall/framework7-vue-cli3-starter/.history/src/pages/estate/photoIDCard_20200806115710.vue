  ...
  <f7-page>
    <div  >
      ...
      <div>   
       ...
       <van-button type="file" class="tit2"  @click="preservation" :data='data'>保存</van-button>
  </f7-page>
</template>
        ...
        methods:{
         uploadIDCards(value){        
          ...
          preservation(file){
            ...
            console.log(file);
            this.item=file.content;
            var formData=new FormData();
            formData.append("身份证正面",file.imgList)
            formData.append("身份证反面",file.imgLists)
            this.data=formData;
          }
        }
