...
//权限菜单
const permissionmenu = (params)=>getAction("/system/sysModules/getUserModulesByToken",params);
//权限管理
...
const queryDepartAuthrity = (params)=>getAction("/sys/sysDepart/getDepartAuthority",params);
//机构管理
