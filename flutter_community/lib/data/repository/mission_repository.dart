...
import 'package:helloworld/data/protocol/mission_models.dart';
...
class MissionRepository {
  ...
  Future<WillRecordModel> willRecordDetail(id) async{
    BaseResp<Map<String,dynamic>> baseResp = await DioUtil().request<Map<String,dynamic>>(Method.get, ShequejiaApi.WILLRECORD_DETAIL+id);
  ...
  Future<ScheduleModel> scheduleDetail(id) async{
    BaseResp<Map<String,dynamic>> baseResp = await DioUtil().request<Map<String,dynamic>>(Method.get, ShequejiaApi.SCHEDULE_DETAIL+id);
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
  ...
  Future<BaseResp> deleteSchedule(id) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.DELETE_SCHEDULE+id);
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
    return baseResp;
  ...
  Future<BaseResp> createSchedule(param) async{
    print(param);
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.CREATE_SCHEDULE,data: param);
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
    return baseResp;
  ...
  Future<BaseResp> createMission(param) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.CREATE_MISSION,data: param);
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
    return baseResp;
  ...
  Future<List<MissionModel>> getMissionList(String startTime,String endTime) async{
    BaseResp<List> baseResp = await DioUtil().request<List>(
        Method.get, ShequejiaApi.MISSION_LIST,data: {'startTime':startTime,'endTime':endTime});
    if (baseResp.code != Constant.status_success) {
      return new Future.error(baseResp.msg);
    }
  ...
  Future<Map<String,dynamic>> getMissionDetail(String missionId) async{
    BaseResp<Map> baseResp = await DioUtil().request<Map>(
        Method.get, ShequejiaApi.SUB_MISSION_LIST+missionId);
    if (baseResp.code != Constant.status_success) {
      return new Future.error(baseResp.msg);
    }
  ...
  Future<List<MissionMessageModel>> getMissionMessageList(String missionId,String userId,String mine) async{
    BaseResp<List> baseResp = await DioUtil().request<List>(
        Method.get, ShequejiaApi.MISSION_MESSAGE + missionId,data: {'userId':userId,'mine':mine});
    if (baseResp.code != Constant.status_success) {
      return new Future.error(baseResp.msg);
    }
  ...
  Future<BaseResp> sendMissionMessage(String missisonId,String message,{String type = 'text',String name=''}) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.MISSION_MESSAGE + missisonId,
  ...
  Future<BaseResp> diliverMission(String missisonId,String recieveUserId,String des) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.DELIVER_MISSION + missisonId,
  ...
  Future<List> uploadFile(File file) async{
    BaseResp<List> baseResp = await DioUtil().requestFile<List>(ShequejiaApi.UPLOADFILE, file);
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
    return baseResp.data;
  ...
  Future updateMissionState(String missionId,String state,String des) async{
    BaseResp baseResp = await DioUtil().request(Method.post,ShequejiaApi.MISSION_STATE_UPDATE + missionId,
  ...
  Future createMeeting(MeetingModelReqs meetingModel) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.CREATE_MEETING,
  ...
  Future<Map<String,dynamic>> getMeetingDetail(String id,String type) async{
    BaseResp<Map> baseResp = await DioUtil().request<Map>(Method.get, ShequejiaApi.MEETING_DETAIL+type+"/"+id,);
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
    return baseResp.data;
  ...
  Future acceptMeeting(String id,String accept,{String reason : ''}) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.MEETING_ACCEPT+id,data:{'reason':reason,'accept':accept});
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
    return baseResp.data;
  ...
  Future meetingCancel(String id,String reason) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.MEETING_CANCEL+id,
    data: {'reason':reason});
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
  ...
  Future willBlowFeedBack(String id,String des) async{
    BaseResp baseResp = await DioUtil().request(Method.post, ShequejiaApi.WILLBLOW_FEEDBACK+id,
    data: {'des':des});
    if(baseResp.code != Constant.status_success){
      return new Future.error(baseResp.msg);
    }
  ...
  Future<List<MissionModel>> getMissionPrepare() async{
    BaseResp<List> baseResp = await DioUtil().request<List>(
        Method.get, ShequejiaApi.MINE_PREPARE);
    if (baseResp.code != Constant.status_success) {
      return new Future.error(baseResp.msg);
    }
    List<MissionModel> missionModelList;
