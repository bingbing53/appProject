...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        serverUrl:window._CONFIG['ssoPrefixUrl']+'/sys/common/uploads',
        ...
        imageUrlPrefix:window._CONFIG['imageViewURL']+"/",
        scrawlUrlPrefix: window._CONFIG['imageViewURL']+"/",
        videoUrlPrefix: window._CONFIG['imageViewURL']+"/",
        fileUrlPrefix: "",
        catcherLocalDomain: "",
        catcherFieldName:'source',
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
        toolbars:[['bold', 'insertorderedlist', 'insertunorderedlist','horizontal','|',
        'justifyleft', 'justifycenter', 'justifyright',/*'customstyle', */'paragraph', '|', 'insertimage','insertvideo', 'attachment', 'link','|','removeformat',
        'undo', 'redo',"dialog"]]
        // toolbars: [
        //         [
        //             "fullscreen",
        ...
        zIndex: 800 //编辑器层级的基数,默认是900
            ...
            //]
            ,'customstyle':[
                {tag:'pre',name:'',label:'', style:'white-space: pre-wrap;'}
            ]
            //打开右键菜单功能
