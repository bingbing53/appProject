...
import 'package:helloworld/tviews/widget/message_chat_item.dart';
...
//                  ),
  ...
  //构建聊天界面
  Widget buildConverChat(BuildContext context,List<dynamic> list,MainBloc bloc){
