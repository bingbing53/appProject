        ...
        <template>
          <a-tabs defaultActiveKey="1" @tabClick="housetabClick" v-model="activeKey">
            <a-tab-pane key="1">
              ...
              <a-row>
                <a-col :span="12">
                    <a-form-item label="所属单元" :labelCol="labelCol" :wrapperCol="wrapperCol"  style="marginBottom:-180px;">
                      <a-row>
                ...
                <a-col :span="12">
                    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="房号">
                      <a-input placeholder="请输入房号" v-decorator="['houseNumber', validatorRules.houseNumber]" />
                    </a-form-item>
                </a-col>
                ...
                <a-col :span="12">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="是否出租">
                    <j-dict-select-tag  v-decorator="['isRent',validatorRules.isRent]" :triggerChange="true" 
                ...
                <a-col :span="12">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="居住类别">
                    <j-dict-select-tag  v-decorator="['liveType', validatorRules.liveType]" :triggerChange="true" placeholder="请选择居住类别"
                                        dictCode="live_type"/>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="房屋面积">
                    <a-input-number v-decorator="['space', {}]" :min="0" :max="99999" :precision="2"/>
                  </a-form-item>
                </a-col>
            ...
            <a-tab-pane key="3">
              ...
              <a-button type="primary" style="float:none" @click="addPersons">添加同住人</a-button>
...
import addressWindow from './AddressTreeWindow' //引入选择单元弹窗组件
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        wrapperCol:{rules:[{required:true,message:"请选择所属单元!"}]},
        houseNumber:{rules:[{required:true ,message:"请输入房间号!"}]},
        isRent:{rules:[{required:true,message:"请选择房屋是否出租!"}]},
        liveType:{rules:[{required:true,message:"请选择居住类别!"}]}
      },
      url: {
