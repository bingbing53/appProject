    ...
    return list.mallData.length == 0
        ...
        : ListView.builder(
            ...
            itemBuilder: (BuildContext context, int i) {
              MallProdcutInfoModel item = list.mallData[i];
              if ((i + 3) == list.mallData.length) {
                print('SearchResultListWidget.build next page,current data count ${list.mallData.length}');
                getNextPage();
              }
              return Container(
