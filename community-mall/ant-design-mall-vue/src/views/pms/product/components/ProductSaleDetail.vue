    ...
    <el-form :model="value" ref="productSaleForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="服务保证：">
        <el-checkbox-group v-model="selectServiceList">
          ...
          <el-checkbox :label="4">爽约、未服务全额退款</el-checkbox>
          <el-checkbox :label="5">不满意免费再服务</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
      ...
      <el-form-item style="text-align: center">
        ...
        <el-button type="primary" size="medium" @click="handleNext">下一步，填写商品规格</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
