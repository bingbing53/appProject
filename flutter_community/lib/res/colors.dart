...
//  static const Color app_main = Color(0xFF666666);
  static const Color app_main = Color(0xFFfe6a6a);
  static const Color app_estate = Color(0xFF44b000);
  ...
  static const Color transparent_40 = Color(0x40000000);
  static const Color transparent_30 = Color(0x30000000);
  ...
  static const Color green_6a = Color(0xff9eea6a);
...
Map<String, Color> themeColorMap = {
  ...
  'work':Color.fromARGB(1, 52, 151, 252),
};
