<template> 
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <div v-show='$route.query.sysCompanyCode!="default"'>
        <el-button
          class="btn-add"
    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
                ...
                border>
        <el-table-column type="selection" width="60" align="center" v-show='$route.query.sysCompanyCode!="default"'></el-table-column>
        ...
        <el-table-column label="商品种类" width="140" align="center">
    ...
    <div class="batch-operate-container" v-show='$route.query.sysCompanyCode!="default"'>
      <el-select
        size="small"
