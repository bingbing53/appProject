<template>
  <div>
    ...
    <van-tabs v-model="active" sticky style="z-index:99;" color='#4374f2'>
      <van-tab title="调查模板" style="z-index:99;"></van-tab>
      <van-tab title="调查记录"></van-tab>
    </van-tabs>
    <van-pull-refresh
      v-if="active==0"
      v-model="investigationList.isLoading"
      @refresh="ondataRefreshModues"
      style="z-index:0;"
    >
      <van-list
    ...
    <van-pull-refresh
      v-if="active==1"
      v-model="investigationDataList.isLoading"
      @refresh="ondataRefresh"
    >
      <van-list :finished="investigationDataList.finished" finished-text="没有更多了" @load="getList">
