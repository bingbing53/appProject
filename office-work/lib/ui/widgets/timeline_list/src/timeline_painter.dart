...
class TimelineBoxDecoration extends Decoration {
  ...
  static const double DEFAULT_ICON_SIZE = 16.0; // default icon size
...
class _TimelinePainterLeft extends _TimelinePainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    final double iconBackgroundRadius =
        iconSize / 4 + TimelineBoxDecoration.LINE_GAP;

    double iconMargin;
    if (iconSize == TimelineBoxDecoration.DEFAULT_DOT_SIZE)
      iconMargin = TimelineBoxDecoration.DEFAULT_ICON_SIZE / 4 +
          TimelineBoxDecoration.LINE_GAP;
    else
