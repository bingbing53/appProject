...
class MessageChatPage extends StatefulWidget{
  const MessageChatPage({Key key, this.labelId,this.model,this.extras}) : super(key: key);
          ...
          new Container(
              ...
              child: GestureDetector(
                ...
                onLongPressUp: (){
                  ...
                  if(end - start < 800){
                    ...
                    if(widget.extras != null && widget.extras.length > 0){
                      bloc.stopRecorder(extras: widget.extras);
                    }else{
                      bloc.stopRecorder();
                    }
                  }
            ...
            new Container(
                ...
                child: new IconButton(
                    ...
                    onPressed: () {
                      if(widget.extras != null && widget.extras.length > 0) {
                        bloc.sendImageMessage(widget.model,extras: widget.extras);
                      }else{
                        bloc.sendImageMessage(widget.model);
                      }
                    }
                )
            ),
            inputType == 'text' ? new RoundButton(
              ...
              onPressed: () {
                if(widget.extras != null && widget.extras.length > 0){
                  bloc.sendMessage(_textController, widget.model,extras: widget.extras);
                }else {
