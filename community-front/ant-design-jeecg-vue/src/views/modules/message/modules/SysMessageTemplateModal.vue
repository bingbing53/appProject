...
<script>
  ...
  import { duplicateCheck,queryModulesList } from '@/api/api'
  ...
  export default {
    ...
    methods: {
      ...
      edit(record) {
        ...
        this.useEditor = (record.templateType==2 || record.templateType == 4 || record.templateType == 5)
        if(this.useEditor){
      ...
      handleChangeTemplateType(value){
        ...
        this.useEditor = (value==2 || value==4 || value==5)
      }
