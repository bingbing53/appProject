<template>
  <div class="main">
    ...
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin" action="https://sso.dev.shequyijia.cn/cas/login" method="post">
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          ...
          <input type="hidden" name="loginUrl" value="https://user.dev.shequyijia.cn/user/login">
...
<script>
  //import md5 from "md5"
  import api from '@/api'
  import SSOCLIENT from '../../cas/client'
  ...
  // document.domain = "shequyijia.cn";
  var constants = {
    loginButt : 'loginButt',
    clientLoginForm : 'formLogin',
    casServerFrame : 'cas_serverFrame',
    loginFormUser : 'username',
    loginFormPassword : 'password',
    serverLoginFormId : 'fm1',
    redirectURLName : 'service',
    casServerURL : 'https://sso.dev.shequyijia.cn/cas/login?service=https://user.dev.shequyijia.cn'
  }
