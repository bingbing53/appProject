...
//              height: 64.0,
//              padding: EdgeInsets.only(left: 6, right: 6, top: 6),
              decoration: BoxDecoration(color: Colours.mainBackgroundColor, borderRadius: BorderRadius.circular(3.0)),
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
            ...
            decoration: BoxDecoration(
//      color: Colors.red,
                border: Border(bottom: BorderSide(width: 1, color: Colours.mainBackgroundColor)))),
      ],
    );
  }
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              height: 25,
              decoration: BoxDecoration(
                color: Colours.mainBackgroundColor,
...
//                height: 164.0,
                decoration:
                    BoxDecoration(color: Colours.mainBackgroundColor, borderRadius: BorderRadius.circular(3.0)),
                child: Center(
                    child: Column(
...
//      color: Colors.red,
  ...
  Widget build(BuildContext context) {
    ...
    print('doi${i}');
    return Container(
      margin: EdgeInsets.only(left: ScreenUtil.getScreenW(context) / 4, top: 0),
      color: Colors.white,
