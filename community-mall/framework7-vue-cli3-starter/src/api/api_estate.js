...
//开门权限申请
const applyDoorAuth = (params)=>postAction("community-estate/api/portal/estate/uploadVerifyInfo",params);

//身份证照片
const photo=(params)=>getAction("community-estate/api/portal/estate/uploadVerifyInfo/idcard",params);
