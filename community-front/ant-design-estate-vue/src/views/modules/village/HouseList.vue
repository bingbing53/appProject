      ...
      <a-card :bordered="false">
            ...
            <a-row :gutter="24">
              <a-col :md="12" :sm="12">
                <a-form-item label="房间号">
                  <a-input placeholder="请输入房间号" v-model="queryParam.houseNumber">
                  </a-input>
                </a-form-item>
              </a-col>
              <a-col :md="12" :sm="12">
        ...
        <div>
          ...
          >
            ...
            <span slot="isRent" slot-scope="text, record">
              <span v-if="record.isRent == '0'">否</span>
              <span v-if="record.isRent == '1'">是</span>
            </span>
