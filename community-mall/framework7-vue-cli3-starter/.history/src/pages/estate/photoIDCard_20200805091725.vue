<template>
  <f7-page>
    <div  >
      ...
      <div>
        <div class="photo" @click="uploadIDCards(0)"   v-if="item.id==1">
           <div v-for="(item,index) in imgList" :key="index" v-else> 
            <img :src="item"  @click="imgs(index)"  width="210" height="145"  class="images1" />
           </div> 
           <div >        
      ...
      <div>   
        <div class="photo"  @click="uploadIDCardss(0)" >
           <div v-for="(item,index) in imgLists" :key="index"> 
            <img :src="item"  @click="imgs1(index)" width="210" height="145" class="images2"/>
           </div> 
           <div>
            <i class="aui-iconfont aui-icon-camera cameraPicture">+</i>
