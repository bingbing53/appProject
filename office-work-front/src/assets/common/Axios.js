...
fly.interceptors.request.use((request) => {
  ...
  // } else {
    //电脑环境
    request.headers = {//设置请求头
      "X-AUTH-TOKEN": 'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJkODc5YzZiOWYzMzE0NTEwYmVjMDM2MDEwNGJiMzI5NyIsInN1YiI6InNvbmdiaW5nIiwiaWF0IjoxNTk4MzI2MDYzfQ.3N9hVc6-_Zz7lhXLwNaUE_lF3MElwwl4-Yw8DZl0sJ4',
      "Content-Type": "application/x-www-form-urlencoded"
      // "Content-Type": "multipart/form-data;charset=utf-8",
    }
