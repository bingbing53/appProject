    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button @click="handleAdd(1)" type="primary" v-has="'depart:add'">添加一级部门</a-button>
        ...
        <div style="background: #fff;padding-left:16px;height: 100%; margin-top: 5px">
          ...
          />
          <!-- 树-->
          <a-col :md="10" :sm="24" style="max-height: 450px;overflow-y: scroll;overflow-x: auto;width: 100%">
            <template>
        ...
        <a-form :form="form">
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="图片">
            <a-upload
              ...
              @change="handleChange"
            >
              <img v-if="!!currSelected.logo" :src="getAvatarView()" alt="头像" style="height:104px;max-width:300px" />
              <div v-else>
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="办公电话">
            <a-input placeholder="请输入电话" v-decorator="['mobile', {'initialValue':''}]" />
          </a-form-item>
          ...
          <!--<a-form-item
            ...
            label="网站首页">
            <a-input placeholder="请输入首页地址" v-decorator="['target', {'initialValue':''}]"/>
          </a-form-item>-->
        </a-form>
...
export default {
  ...
  methods: {
    ...
    handleChange(info) {
      ...
      if (info.file.status === 'done') {
        ...
        if (response.code == 200) {
          this.currSelected.logo = response.url
    ...
    getAvatarView() {
      return this.url.imgerver + '/' + this.currSelected.logo
    },
    loadData() {
      this.refresh()
    },
