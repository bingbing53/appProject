...
final List<_Page> _allPages = <_Page>[
  new _Page(Ids.titleMessage),
  new _Page(Ids.titleWork),
  new _Page(Ids.titleChat),
  new _Page(Ids.titleMine),
  ...
  Widget buildTabView(BuildContext context, _Page page) {
    ...
    switch (labelId) {
      case Ids.titleMessage:
        return MessagePage(labelId: labelId);
        break;
      case Ids.titleWork:
        return WorkPage(labelId: labelId);
        break;
      case Ids.titleChat:
        return ChatPage(labelId: labelId);
        break;
      case Ids.titleMine:
        return MinePage();
        break;
