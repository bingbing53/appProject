...
class GZXSearchActivityResultListWidget extends StatelessWidget {
  final SearchActivityResultListModal list;
  final ValueChanged<String> onItemTap;
  final VoidCallback getNextPage;

  GZXSearchActivityResultListWidget(this.list, {this.onItemTap, this.getNextPage});
...
//            itemExtent: 127,
            itemBuilder: (BuildContext context, int i) {
              ...
              return  ListActivityViewItem(item:list.data[i]);
//              return Container(
