...
//    LogUtil.e("RefreshScaffold initState......" + widget.labelId);
  ...
  Widget build(BuildContext context) {
    LogUtil.e("RefreshScaffold build...... ${widget.labelId}   ${widget.loadStatus}");
    super.build(context);
    return new Scaffold(
        body: new Stack(
          children: <Widget>[
            new RefreshIndicator(
                child: new SmartRefresher(
                    footerBuilder: ((BuildContext context, int mode){return new ClassicIndicator(mode:mode,idleText: "下拉刷新",noDataText: '没有更多了',refreshingText: '努力加载中...',);}),
